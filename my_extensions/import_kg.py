...
9. Import knowledge graph using LightRAG's insert_custom_kg method
...
def main():
    """Main function to import the knowledge graph"""
    ...
    try:
        ...
        # Insert knowledge graph - using the non-async method
        print(f"Importing {graph_type} knowledge graph into LightRAG...")
        try:
            # Use the regular non-async method
